        ...
        <aside class="grid_3">
            ...
            <ul>
                <li class="d-t list-n">
                    ...
                    <div class="d-tc">
                        <a href="index.php"><h3 class="mb-0">Add a New Project</h3></a>
                    </div>
                </li>
                <?php projectList(); ?>
            </ul>
            ...
            <div class="grid_6 alpha">
                ...
                <form action="" method="POST" enctype="multipart/form-data" style="width:100%;">
                    <?php
                        ...
                        if(isset($ProjName)){
                            $form .= '
                            <input class="project-action-btn save-btn" type="button" id="save" data-id="update" value="Save Project" />
                            <input class="project-action-btn" type="button" data-id="update" value="Save &amp; Modify Images" />';
                        } else {
                            $form .= '
                            <input class="project-action-btn save-btn" type="button" id="save" data-id="add" value="Save Project" />
                            <input class="project-action-btn" type="button" data-id="add" value="Save &amp; Add Images" />';
                        }
