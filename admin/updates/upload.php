<?php session_start();
    $sessionProject = $_SESSION['update'];
...
<?php
    ...
    include($path.'/admin/updates/functions.inc.php');
        
    $database = "ehconstruction";
    mysql_select_db("$database") or die(mysql_error());
    
    $ouptut_date = date('Y').'/'.date('m');
    $output_dir = "../../images/updates/".$ouptut_date."/";
    ...
    if(isset($_FILES['files'])){
        ...
        foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){
            ...
            if(empty($errors)==true){
                ...
                if(file_exists("$output_dir".$file_name)){
                    ...
                    $addfile = "INSERT INTO update_img (ImageName,ImageLink,ImageTitle,ImageCaption,fk_UID) VALUES ('$file_name','$output_dir','','','$UpdateId');";
        ...
        if(empty($errors)){
            ...
            mysql_close();
            header("Location: upload.php?updateID=$UpdateId");
...
<div class="container_12">
    <aside class="grid_12" style="background: #eaeaea;">
        ...
        <a href="index.php?updateID=<?php echo $ProjectId; ?>" class="btn">Back</a> | 
